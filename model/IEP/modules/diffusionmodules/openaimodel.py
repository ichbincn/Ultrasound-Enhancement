...
from model.IEP.modules.diffusionmodules.util import (
    checkpoint,
    conv_nd,
    linear,
    avg_pool_nd,
...
from model.IEP.modules.attention import SpatialTransformer
...
# For encode the ocr feature output
class TextFeature_EncoderUNetModel(nn.Module):
    """
    The half UNet model with attention and timestep embedding.
    For usage, see UNet.
    """
